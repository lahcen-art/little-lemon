...
function Footer() {
  return (
    <footer role="contentinfo" aria-label="Site footer" className="professional-footer">
      <div className="footer-content">
        <div className="footer-left">
          <img src={footerLogo} alt="Little Lemon Restaurant Logo" className="footer-logo" />
        ...
        <div className="footer-center">
          <div className="footer-section">
            ...
            <ul>
              ...
              <li><a href="/#about" aria-label="Learn about Little Lemon">About</a></li>
